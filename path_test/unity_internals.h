...
typedef void (*UnityTestFunction)(Graph * G, char * filename);
...
#ifndef RUN_TEST
void UnityDefaultTestRun(UnityTestFunction Func, const char* FuncName, const int FuncLineNum,Graph * G, char * filename);
#else
